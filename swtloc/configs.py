...
CONFIG__SWTIMAGE__FINDANDPRUNECC = 'swtimage.findandprunecc'
CONFIG__SWTIMAGE__FINDANDPRUNECC_MAXIMUM_PIXELS_PER_CC = f'{CONFIG__SWTIMAGE__FINDANDPRUNECC}.maximum_pixels_per_cc'
CONFIG__SWTIMAGE__FINDANDPRUNECC_MINIMUM_PIXELS_PER_CC = f'{CONFIG__SWTIMAGE__FINDANDPRUNECC}.minimum_pixels_per_cc'
CONFIG__SWTIMAGE__FINDANDPRUNECC_ACCEPTABLE_ASPECT_RATIO = f'{CONFIG__SWTIMAGE__FINDANDPRUNECC}.acceptable_aspect_ratio'
CONFIG__SWTIMAGE__FINDANDPRUNECC_DISPLAY = f'{CONFIG__SWTIMAGE__FINDANDPRUNECC}.display'
...
# For swtimage.findAndPruneConnectedComponents
config[f'{CONFIG__SWTIMAGE__FINDANDPRUNECC_MAXIMUM_PIXELS_PER_CC}.type'] = [int]
config[f'{CONFIG__SWTIMAGE__FINDANDPRUNECC_MAXIMUM_PIXELS_PER_CC}.options'] = None
config[f'{CONFIG__SWTIMAGE__FINDANDPRUNECC_MAXIMUM_PIXELS_PER_CC}'] = 10_000

config[f'{CONFIG__SWTIMAGE__FINDANDPRUNECC_MINIMUM_PIXELS_PER_CC}.type'] = [int]
config[f'{CONFIG__SWTIMAGE__FINDANDPRUNECC_MINIMUM_PIXELS_PER_CC}.options'] = None
config[f'{CONFIG__SWTIMAGE__FINDANDPRUNECC_MINIMUM_PIXELS_PER_CC}'] = 50

config[f'{CONFIG__SWTIMAGE__FINDANDPRUNECC_ACCEPTABLE_ASPECT_RATIO}.type'] = [float]
config[f'{CONFIG__SWTIMAGE__FINDANDPRUNECC_ACCEPTABLE_ASPECT_RATIO}.options'] = None
config[f'{CONFIG__SWTIMAGE__FINDANDPRUNECC_ACCEPTABLE_ASPECT_RATIO}'] = 0.2

config[f'{CONFIG__SWTIMAGE__FINDANDPRUNECC_DISPLAY}.type'] = [bool]
config[f'{CONFIG__SWTIMAGE__FINDANDPRUNECC_DISPLAY}.options'] = [True, False]
config[f'{CONFIG__SWTIMAGE__FINDANDPRUNECC_DISPLAY}'] = True
