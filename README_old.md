...
⚠️- This **README.md** is deprecated alongside *Usage* as mentioned here from v2.0.0 onwards. Go to [README.md](README.md). This README_old.md will be removed in v2.1.0.
